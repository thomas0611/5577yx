...
namespace Common
{
    public static class Json
    {
        ...
        public static Dictionary<string, string> JsonToArray(string JsonStr)
        {
            Dictionary<string, string> JsonData = new Dictionary<string, string>();
            JsonStr = JsonStr.Substring(0, JsonStr.IndexOf('}'));
            JsonStr = JsonStr.Replace(JsonStr.Substring(0, JsonStr.LastIndexOf('{') + 1), "");
            foreach (string data in JsonStr.Split(','))
            {
                string[] Re = data.Split(':');
                JsonData.Add(Re[0].Replace("\"", ""), Re[1].Replace("\"", ""));
            }
            return JsonData;
