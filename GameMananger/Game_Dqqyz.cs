...
namespace Game.Manager
{
    public class Game_Dqqyz : IGame
    {
        ...
        public string Login(int UserId, int ServerId, int IsPC)
        {
            ...
            string LoginUrl = "http://" + gc.LoginCom + "?sid=" + gc.AgentId + "&gid=" + "GameId" + "&servid=" + gs.ServerNo + "&username=" + gu.UserName + "&isAdult=1&time=" + tstamp + "&MD5=" + Sign;       //生成登录地址
            return LoginUrl;
        }
        ...
        public string Pay(string OrderNo)
        {
            ...
            if (gus.IsGameUser(gu.UserName))                                //判断用户是否属于平台
            {
                ...
                string PayUrl = "http://" + gc.PayCom + "?sid=" + gc.AgentId + "&gid=1&servid=" + gs.ServerNo + "&username=" + gu.UserName + "&rmb=" + order.PayMoney + "&orderid=" + OrderNo + "&paytime=" + tstamp + "&md5=" + Sign;
        ...
        public GameUserInfo Sel(int UserId, int ServerId)
        {
            ...
            string SelUrl = "http://" + gs.ServerNo + "." + gc.ExistCom + "?sid=" + gc.AgentId + "&gid=1&servid=" + gs.ServerNo + "&username=" + gu.UserName;      //获取查询地址
